...
use Airondev\pCloud\Request as PcloudRequest;


class PcloudAdapter extends AbstractAdapter
{
     ...
     */
    public function __construct(File $client, $config = ['container' => 1], $prefix = null)
    {
        $this->client = $client;
    ...
    public function readStream($pathName)
    {
        ...
        try {
            $fileResult = $this->client->getLink($location);
        } catch (ServiceException $e) {
            if ($e->getCode() === 404) {
